...
### [Step 5] 독립 (Graduation) 및 첫 주간 월세 정산 과제
- **목표**: 전체 시스템 자유도 부여 및 첫 주간 생존 목표 수립.
- **액션**:
...
- **첫 번째 자립 과제 (The First Independent Task)**:
    - **월세 정산 72시간 면제 룰**: 가입 시점으로부터 72시간(3일) 이내에 도래하는 월요일 정산은 자동 면제(Bypass).
    - **목표 부여**: "가입 후 72시간 이후 도래하는 첫 정산일 전까지: **현금 5,000G(기본 월세) 확보하기**" 퀘스트 등록.
    - 안나의 응원 대사(`TUT_06_SETTLEMENT_GOAL`) 출력.
