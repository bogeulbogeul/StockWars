...
| ID | 중요도 | 작업 항목 | 진행 상태 | 시작일 | 종료일 | 세부 구현 내용 및 명세 |
| :---: | :---: | :--- | :---: | :---: | :---: | :--- |
| **3-1** | 🔴 P0 | **타운 (Public Town) 맵 & 물류센터 이동 연출** | ✅ 완료 | 2026-09-20 | 2026-09-22 | 안나 외출 제안 연동, 오피스 문(`FURN_WALL_NS_DOOR`) 근접 시 `[F] 마을로 나가기` 인터랙션 및 타운 서버/채널 선택 모달(`ServerSelectModal`) 연동 완료 |
| **3-2** | 🔴 P0 | **비트 물류창고 (Bit Logistics) 시설 연동** | ✅ 완료 | 2026-09-22 | 2026-09-22 | 관리소장 박씨(Manager Park) NPC 상호작용 및 비트 물류 상하차 미니게임 모달(`LogisticsMiniGame`) 연동 완료 |
| **3-3** | 🔴 P0 | **60초 화물 운송 미니게임 (Side-View Physics)** | ✅ 완료 | 2026-09-22 | 2026-09-22 | 사이드뷰 화물 운송: A/D 키 이동, [Shift] 가속, 우측 상자 픽업 ➔ 좌측 트럭 적재 ➔ 빈손 귀환 루프, 파손 위험 게이지, 상단 티커 |
