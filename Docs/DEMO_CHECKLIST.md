...
| ID | 중요도 | 작업 항목 | 진행 상태 | 시작일 | 종료일 | 세부 구현 내용 및 명세 |
| :---: | :---: | :--- | :---: | :---: | :---: | :--- |
| **3-1** | 🔴 P0 | **타운 (Public Town) 맵 & 물류센터 이동 연출** | 🔄 진행중 | 2026-09-20 | - | 안나 외출 제안 연동, 오피스 문(`FURN_WALL_NS_DOOR`) 근접 시 `[F] 마을로 나가기` 인터랙션 및 타운 서버/채널 선택 모달(`ServerSelectModal`) 연동 완료 |
| **3-2** | 🔴 P0 | **비트 물류창고 (Bit Logistics) 시설 연동** | ⏳ 대기 | - | - | 관리소장 박씨(Manager Park) NPC 상호작용 및 대화 팝업, 일일 스테미나 제한(3~5회) 연동 |
| **3-3** | 🔴 P0 | **60초 화물 운송 미니게임 (Side-View Physics)** | ⏳ 대기 | - | - | 사이드뷰 화물 운송: [Shift] 가속, 관성 제어, 지정 하차 구역 운반, 급가속/충돌 파손 게이지, 상단 찌라시 티커 |
| **3-4** | 🔴 P0 | **작업 정산 및 보상 체계** | ⏳ 대기 | - | - | 60초 등급(S:800G/A:560G/B:320G/C:100G) 산정 및 골드/EXP 지급, 찌라시 보너스(30%), 황금 잭팟(0.002%) |
| **3-5** | 🔴 P0 | **스테미나 회복 루프 (비비안 잡화점)** | ⏳ 대기 | - | - | 안나 기력 회복 안내(`TUT_04_STAMINA_HEAL`), 비비안 잡화점 이동 ➔ 에너지 드링크(500G) 구매 ➔ 인벤토리 즉시 섭취 |
