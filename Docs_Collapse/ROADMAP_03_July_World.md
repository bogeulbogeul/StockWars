# ROADMAP 03: 7월 (캡스톤 전반부: 오피스 하우징 & 그리드 시스템)
...
### 📐 Track 1: 아이소메트릭 그리드 및 오피스 하우징 핵심 메카닉 (Isometric Grid & Housing Mechanics)
...
### 🧱 Track 2: 건설/배치 비주얼 및 이펙트 연출 (Construction Visuals & Placement FX)
...
### ⚡ Track 3: 가구 스탯 기여도 및 편의 기능 (Furniture Stats & Utility)
...
### 🚶 Track 4: 타운 월드 인프라 및 카메라/이동 시스템 (Town Infrastructure & Camera System)
...
### 👥 Track 5: NPC 월드 스폰 및 생활 패턴 AI (NPC Spawning & Routine AI)
...
### 🌃 Track 6: 월드 환경 조명, 셰이더 및 시각 연출 (Environmental Lighting & Shaders)
...
### 📈 Track 7: 공매도 및 강제 청산/압류 엔진 (Short Selling & Seizure Engine)
