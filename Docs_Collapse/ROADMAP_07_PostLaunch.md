...
### 🏢 Track 1: 옵시디언 기관 투자자 시스템 핵심 인프라 (Obsidian Institutional Core)
...
### 📉 Track 2: 기관 공매도 및 마진콜/대차 자동상환 (Institutional Shorting & Margin Cover)
...
### 💰 Track 3: 자금 횡령, 탈세 및 비정상 내부 고발 감지 (Embezzlement & Internal Controls)
...
### 🚨 Track 4: 적색 수배 패널티 및 탈출/자수 퀘스트 (Red Notice Arrest & Recovery)
...
### 🏚️ Track 5: 전당포 금융 대출 및 중고 담보 시장 (Pawnshop Financing & Collateral Market)
...
### 📈 Track 6: 신규 공석 상장주 선정 및 축하 세레머니 (Dynamic IPO Reserve & Ceremonies)
